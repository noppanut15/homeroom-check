        ...
        <div class="col-xl-4 col-md-8 col-sm-12 bg-light rounded-lg shadow p-4">
            <form method="POST">
                ...
                <div class="input-group mb-2">
                    ...
                    <input name="username" type="text" id="username" class="form-control" placeholder="ชื่อผู้ใช้" required autofocus>
                </div>
                <label for="inputPassword" class="sr-only">รหัสผ่าน</label>
                <div class="input-group">
                    <span class="input-group-text"><i class="fas fa-key"></i></span>
                    <input name="password" type="password" id="inputPassword" class="form-control" placeholder="รหัสผ่าน" required>
                </div>
                <button class="btn btn-lg btn-danger btn-block my-3" type="submit" name="submit" value="submit"><i class="fas fa-sign-in-alt"></i> เข้าสู่ระบบ</button>
            </form>
        </div>
    </div>
</div>
