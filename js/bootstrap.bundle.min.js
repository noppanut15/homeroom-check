...
!(function (t, e) {
  ...
  V.on(
    ...
    V.on(document, "click.bs.dropdown.data-api", ".dropdown form", function (
      t
    ) {
  ...
  V.on(document, "click.bs.modal.data-api", '[data-toggle="modal"]', function (
    t
  ) {
    var e = this,
      n = h(this);
