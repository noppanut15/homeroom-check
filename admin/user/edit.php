            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <select name="role" id="role" required class="form-select">
                        ...
                        <option value="1" <?php if($role == 1) echo 'selected'; ?>>ครูประจำชั้น</option>
                        <option value="99" <?php if($role == 99) echo 'selected'; ?>>ผู้ดูแลระบบ</option>
                    </select>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-6 col-sm-12">
                    ...
                    <select name="level" id="level" class="form-select" required>
                        ...
                        <option value="0" <?php if($level == 0) echo 'selected'; ?>>ไม่ประจำชั้น</option>
                        <option value="1" <?php if($level == 1) echo 'selected'; ?>>ม.1</option>
                        <option value="2" <?php if($level == 2) echo 'selected'; ?>>ม.2</option>
                        <option value="3" <?php if($level == 3) echo 'selected'; ?>>ม.3</option>
                        <option value="4" <?php if($level == 4) echo 'selected'; ?>>ม.4</option>
                        <option value="5" <?php if($level == 5) echo 'selected'; ?>>ม.5</option>
                        <option value="6" <?php if($level == 6) echo 'selected'; ?>>ม.6</option>
                    </select>
                </div>
                <div class="col-md-6 col-sm-12">
                    ...
                    <select name="room" id="room" class="form-select" required>
                        ...
                        <option value="0" <?php if($room == 0) echo 'selected'; ?>>ไม่ประจำชั้น</option>
                        ...
                        <option value="7" <?php if($room == 7) echo 'selected'; ?>>ห้อง 7</option>
                        <option value="8" <?php if($room == 8) echo 'selected'; ?>>ห้อง 8</option>
                        <option value="9" <?php if($room == 9) echo 'selected'; ?>>ห้อง 9</option>
                        <option value="10" <?php if($room == 10) echo 'selected'; ?>>ห้อง 10</option>
                        <option value="11" <?php if($room == 11) echo 'selected'; ?>>ห้อง 11</option>
                        <option value="12" <?php if($room == 12) echo 'selected'; ?>>ห้อง 12</option>
                        <option value="13" <?php if($room == 13) echo 'selected'; ?>>ห้อง 13</option>
                        <option value="14" <?php if($room == 14) echo 'selected'; ?>>ห้อง 14</option>
                    </select>
                </div>
            </div>
        </div>
